        ...
        <!-- Mobile navbar -->
          ...
          <div class="px-4 py-3 flex items-center justify-between">
            <div class="flex items-center">
              <img src="/images/logo1.jpeg" alt="FasCare Logo" class="w-10 h-10 rounded-full">
              <span class="ml-3 text-lg font-bold text-white">FasCare</span>
            </div>
        ...
        <div class="hidden md:block">
          <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
              <div class="flex items-center">
                <img src="/images/logo.png" alt="FasCare Logo" class="w-12 h-12 rounded-full">
                <span class="ml-4 text-xl font-bold text-white">FasCare</span>
              </div>
